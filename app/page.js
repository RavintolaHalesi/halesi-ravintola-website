...
export default function HomePage() {
  ...
  return (
    <><ScrollReset />
      {showOpeningNotice ? (
        <div className="openingNoticeOverlay" role="dialog" aria-modal="true" aria-label="Thursday lunch menu notice">
          <div className="openingNoticeCard">
            ...
            <img src="/assets/thursday-lunch-popup-2026-08-26.jpeg" alt="Thursday lunch menu" className="openingNoticeImage" />
          </div>
        </div>
      ) : null}
      <main className="page">
